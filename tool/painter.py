...
if __name__ == '__main__':
	input_image = np.array(Image.open('/data2/cym/Seg_Tra_any/Segment-and-Track-Anything/debug/painter_input_image.jpg').convert('RGB'))
	input_mask = np.array(Image.open('/data2/cym/Seg_Tra_any/Segment-and-Track-Anything/debug/painter_input_mask.jpg').convert('P'))
	...
	# painted_image.save('/data2/cym/Seg_Tra_any/Segment-and-Track-Anything/debug/painter_input_mask.jpg')

	painted_image = mask_painter(input_image, input_mask, mask_color, mask_alpha, contour_color, contour_width)
	# save
	painted_image = Image.fromarray(input_image)
	painted_image.save('/data2/cym/Seg_Tra_any/Segment-and-Track-Anything/debug/mask_painter.png')

	# example of point painter
	# input_image = np.array(Image.open('/data2/cym/Seg_Tra_any/Segment-and-Track-Anything/debug/painter_input_image.jpg').convert('RGB'))
	# input_points_1 = np.array([[500, 375], [70, 600]])	# x, y
	# input_points_2 = np.array([[250, 304], [300, 350]])
	# point_color = 5
	# point_alpha = 0.9
	# point_radius = 15
	# contour_color = 2
